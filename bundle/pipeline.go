...
func (b *Bundle) StartPipelineCron(cronID uint64) (*cronpb.Cron, error) {
	host, err := b.urls.Pipeline()
	if err != nil {
		return nil, err
	}
...
func (b *Bundle) StopPipelineCron(cronID uint64) (*cronpb.Cron, error) {
	host, err := b.urls.Pipeline()
	if err != nil {
		return nil, err
	}
...
func (b *Bundle) GetPipelineCron(cronID uint64) (*cronpb.Cron, error) {
	host, err := b.urls.Pipeline()
	if err != nil {
		return nil, err
	}

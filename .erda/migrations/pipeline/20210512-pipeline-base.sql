...
INSERT INTO `dice_pipeline_lifecycle_hook_clients` (`id`, `host`, `name`, `prefix`) VALUES (1,'fdp-master.default.svc.cluster.local:8080','FDP','/api/fdp/workflows');
...
INSERT INTO `pipeline_configs` (`id`, `type`, `value`) VALUES (1,'action_executor','{\n	\"kind\": \"SCHEDULER\",\n	\"name\": \"scheduler\",\n	\"options\": {\n		\"ADDR\": \"scheduler.marathon.l4lb.thisdcos.directory:9091\"\n	}\n}');
...
CREATE TABLE `pipeline_crons` (
  ...
  `pipeline_source` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pipeline_yml_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',

...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='addon attach信息';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='addon操作审计信息';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='addon额外信息';


INSERT INTO `tb_addon_extra` (`id`, `addon_id`, `field`, `value`, `create_time`, `update_time`, `is_deleted`, `addon_name`) VALUES ('5f17832361a54247a3272d7b49a1ae78','','DICE_CORE_CLUSTER','terminus-test','2018-11-08 19:22:51','2018-11-08 20:25:05','N',NULL),('5f17832361a54247a3272d7b49a1ae79','955aa1e091204232b4de927d92681638','RESOURCE_URL','http://terminus-dice.oss-cn-hangzhou.aliyuncs.com/addon/sql/config_center.sql\n','2018-11-08 19:22:51','2018-11-08 20:25:05','N',NULL);
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='addon实例信息';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='microservice addon attach信息';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='addon创建流程记录信息';

...
(
    ...
    `prod_runtimes_count`      INTEGER      NOT NULL DEFAULT 0 COMMENT '采集时 runtimes 数量',
    ...
    `staging_runtimes_count`   INTEGER      NOT NULL DEFAULT 0 COMMENT '采集时 runtimes 数量',
    ...
    `test_runtimes_count`      INTEGER      NOT NULL DEFAULT 0 COMMENT '采集时 runtimes 数量',
    ...
    `dev_runtimes_count`       INTEGER      NOT NULL DEFAULT 0 COMMENT '采集时 runtimes 数量',

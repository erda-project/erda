...
CREATE TABLE IF NOT EXISTS `sp_authentication` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `sp_chart_meta` (
...
CREATE TABLE IF NOT EXISTS `sp_log_deployment` (
...
CREATE TABLE IF NOT EXISTS `sp_log_instance` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `sp_maintenance` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `sp_metric` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `project_id` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `sp_monitor` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `sp_report_settings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `sp_service` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `sp_stage` (
...
CREATE TABLE IF NOT EXISTS `sp_status` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `sp_trace_request_history` (
...
CREATE TABLE IF NOT EXISTS `tb_tmc` (
...
CREATE TABLE IF NOT EXISTS `tb_tmc_ini` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增id',
...
CREATE TABLE IF NOT EXISTS `tb_tmc_instance` (
...
CREATE TABLE IF NOT EXISTS `tb_tmc_instance_tenant` (
...
CREATE TABLE IF NOT EXISTS `tb_tmc_request_relation` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增id',
...
CREATE TABLE IF NOT EXISTS `tb_tmc_version` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增id',
  `engine` varchar(32) NOT NULL COMMENT '内核名称',
  `version` varchar(32) NOT NULL COMMENT '版本',

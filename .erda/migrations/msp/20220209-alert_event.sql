...
(
    ...
    alert_group_id     varchar(255)                        NOT NULL COMMENT '告警分组id',
    ...
    alert_subject      varchar(255)                        NOT NULL COMMENT '告警对象',
...
(
    ...
    `enable`         bit         NOT NULL COMMENT '是否启用',

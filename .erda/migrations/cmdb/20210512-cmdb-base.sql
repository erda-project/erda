...
CREATE TABLE `dice_config_namespace` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_name` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='配置项namespace';
...
INSERT INTO `dice_notify_items` (`id`, `created_at`, `updated_at`, `name`, `display_name`, `category`, `mobile_template`, `mbox_template`, `email_template`, `dingding_template`, `scope_type`, `label`, `params`, `vms_template`, `called_show_number`) VALUES (1,'2021-05-12 09:45:46','2021-05-12 09:45:46','git_push','代码推送','git',NULL,'### {{projectName}}/{{appName}} 代码推送\n- 推送前commit：{{beforeID}}\n- 推送后commit：{{afterID}}\n- 推送引用：{{ref}}\n- 提交人：{{pusherName}}','<p>{{projectName}}/{{appName}} 代码推送 </p>\n<p>推送前commit： {{beforeID}}</p>\n<p>推送后commit： {{afterID}}</p>\n<p>推送引用 ：{{ref}}</p>\n<p>提交人：{{pusherName}}</p>','### {{projectName}}/{{appName}} 代码推送\n- 推送前commit：{{beforeID}}\n- 推送后commit：{{afterID}}\n- 推送引用：{{ref}}\n- 提交人：{{pusherName}}','app','workbench','projectName,appName,beforeID,afterID,ref,pusherName',NULL,NULL),(2,'2021-05-12 09:45:46','2021-05-12 09:45:46','Failed','工作流运行失败','workflow',NULL,NULL,'<p>工作流名:{{workflowName}}</p>\n<p>工作流ID: {{workflowID}}</p>\n<p>pipelineID:{{pipelineID}}</p>\n<p>事件名:{{notifyItemName}}</p>\n{{failedDetail}}',NULL,'org','cdp','workflowName,workflowID,pipelineID,notifyItemName,failedDetail',NULL,NULL),(3,'2021-05-12 09:45:46','2021-05-12 09:45:46','Running','工作流开始运行','workflow',NULL,NULL,'<p>工作流名:{{workflowName}}</p>\n<p>工作流ID: {{workflowID}}</p>\n<p>pipelineID:{{pipelineID}}</p>\n<p>事件名:{{notifyItemName}}</p>',NULL,'org','cdp','workflowName,workflowID,pipelineID,notifyItemName',NULL,NULL),(4,'2021-05-12 09:45:46','2021-05-12 09:45:46','Success','工作流运行成功','workflow',NULL,NULL,'<p>工作流名:{{workflowName}}</p>\n<p>工作流ID: {{workflowID}}</p>\n<p>pipelineID:{{pipelineID}}</p>\n<p>事件名:{{notifyItemName}}</p>',NULL,'org','cdp','workflowName,workflowID,pipelineID,notifyItemName',NULL,NULL),(5,'2021-05-12 09:46:25',NULL,'pipeline_running',NULL,'pipeline',NULL,NULL,NULL,NULL,'app','workbench',NULL,NULL,NULL),(6,'2021-05-12 09:46:25',NULL,'pipeline_success',NULL,'pipeline',NULL,NULL,NULL,NULL,'app','workbench',NULL,NULL,NULL),(7,'2021-05-12 09:46:25',NULL,'pipeline_failed',NULL,'pipeline',NULL,NULL,NULL,NULL,'app','workbench',NULL,NULL,NULL),(8,'2021-05-12 09:46:25',NULL,'issue_create',NULL,'issue',NULL,NULL,NULL,NULL,'project','workbench',NULL,NULL,NULL),(9,'2021-05-12 09:46:25',NULL,'issue_update',NULL,'issue',NULL,NULL,NULL,NULL,'project','workbench',NULL,NULL,NULL),(10,'2021-05-12 09:46:25',NULL,'git_create_mr',NULL,'git',NULL,NULL,NULL,NULL,'app','workbench',NULL,NULL,NULL),(11,NULL,NULL,'git_merge_mr',NULL,'git',NULL,NULL,NULL,NULL,'app','workbench',NULL,NULL,NULL),(12,NULL,NULL,'git_close_mr',NULL,'git',NULL,NULL,NULL,NULL,'app','workbench',NULL,NULL,NULL),(13,NULL,NULL,'git_comment_mr',NULL,'git',NULL,NULL,NULL,NULL,'app','workbench',NULL,NULL,NULL),(14,NULL,NULL,'git_delete_branch',NULL,'git',NULL,NULL,NULL,NULL,'app','workbanch',NULL,NULL,NULL),(15,NULL,NULL,'git_delete_tag',NULL,'git',NULL,NULL,NULL,NULL,'app','workbanch',NULL,NULL,NULL);
...
CREATE TABLE `ps_user_current_org` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户当前所属企业';
...
CREATE TABLE `dice_error_box` (
                                  ...
                                  `created_at` datetime DEFAULT NULL COMMENT '表记录创建时间',
                                  `updated_at` datetime DEFAULT NULL COMMENT '表记录更新时间',
                                  `resource_type` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '资源类型',
                                  `resource_id` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '资源id',
                                  `occurrence_time` datetime NOT NULL COMMENT '日志发生时间',
                                  `human_log` text COLLATE utf8mb4_unicode_ci COMMENT '处理过的日志和提示',
                                  `primeval_log` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '原生错误',
                                  `dedup_id` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '去重id',
                                  `level` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT 'error' COMMENT '日志级别',
                                  PRIMARY KEY (`id`),
...
INSERT INTO `dice_member` (`id`, `scope_type`, `scope_id`, `scope_name`, `parent_id`, `org_id`, `project_id`, `project_name`, `application_id`, `application_name`, `role`, `user_id`, `email`, `mobile`, `nick`, `avatar`, `user_sync_at`, `created_at`, `updated_at`, `name`, `token`) VALUES (1,'sys',0,'',0,0,0,'',0,'','Owner','1','admin@dice.terminus.io',NULL,'admin','','2019-08-16 14:55:15','2019-08-16 14:55:15','2019-08-16 14:55:15','admin',NULL);

CREATE TABLE `dice_member_extra` (
                                     `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                     `created_at` datetime DEFAULT NULL COMMENT '表记录创建时间',
                                     `updated_at` datetime DEFAULT NULL COMMENT '表记录更新时间',
                                     `user_id` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '成员的用户id',
                                     `parent_id` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT '0' COMMENT '成员的父scope id',
                                     `scope_id` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '成员所属scope id',
                                     `scope_type` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '成员所属scope类型',
                                     `resource_key` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '成员关联资源的键',
                                     `resource_value` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '成员关联资源的值',
                                     PRIMARY KEY (`id`),
...
INSERT INTO `dice_member_extra` (`id`, `created_at`, `updated_at`, `user_id`, `parent_id`, `scope_id`, `scope_type`, `resource_key`, `resource_value`) VALUES (1,'2019-08-16 14:55:15','2019-08-16 14:55:15','1','0','0','sys','role','Owner');

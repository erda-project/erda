...
INSERT INTO `dice_notify_items` (`id`, `created_at`, `updated_at`, `name`, `display_name`, `category`, `mobile_template`, `mbox_template`, `email_template`, `dingding_template`, `scope_type`, `label`, `params`, `vms_template`, `called_show_number`) VALUES (1,'2021-05-28 03:30:23','2021-05-28 03:30:23','git_push','代码推送','git',NULL,'### {{projectName}}/{{appName}} 代码推送\n- 推送前commit：{{beforeID}}\n- 推送后commit：{{afterID}}\n- 推送引用：{{ref}}\n- 提交人：{{pusherName}}','<p>{{projectName}}/{{appName}} 代码推送 </p>\n<p>推送前commit： {{beforeID}}</p>\n<p>推送后commit： {{afterID}}</p>\n<p>推送引用 ：{{ref}}</p>\n<p>提交人：{{pusherName}}</p>','### {{projectName}}/{{appName}} 代码推送\n- 推送前commit：{{beforeID}}\n- 推送后commit：{{afterID}}\n- 推送引用：{{ref}}\n- 提交人：{{pusherName}}','app','workbench','projectName,appName,beforeID,afterID,ref,pusherName',NULL,NULL),(2,'2021-05-28 03:30:23','2021-05-28 03:30:23','Failed','工作流运行失败','workflow',NULL,NULL,'<p>工作流名:{{workflowName}}</p>\n<p>工作流ID: {{workflowID}}</p>\n<p>pipelineID:{{pipelineID}}</p>\n<p>事件名:{{notifyItemName}}</p>\n{{failedDetail}}',NULL,'org','cdp','workflowName,workflowID,pipelineID,notifyItemName,failedDetail',NULL,NULL),(3,'2021-05-28 03:30:23','2021-05-28 03:30:23','Running','工作流开始运行','workflow',NULL,NULL,'<p>工作流名:{{workflowName}}</p>\n<p>工作流ID: {{workflowID}}</p>\n<p>pipelineID:{{pipelineID}}</p>\n<p>事件名:{{notifyItemName}}</p>',NULL,'org','cdp','workflowName,workflowID,pipelineID,notifyItemName',NULL,NULL),(4,'2021-05-28 03:30:23','2021-05-28 03:30:23','Success','工作流运行成功','workflow',NULL,NULL,'<p>工作流名:{{workflowName}}</p>\n<p>工作流ID: {{workflowID}}</p>\n<p>pipelineID:{{pipelineID}}</p>\n<p>事件名:{{notifyItemName}}</p>',NULL,'org','cdp','workflowName,workflowID,pipelineID,notifyItemName',NULL,NULL),(5,'2021-05-28 03:54:58',NULL,'pipeline_running',NULL,'pipeline',NULL,NULL,NULL,NULL,'app','workbench',NULL,NULL,NULL),(6,'2021-05-28 03:54:58',NULL,'pipeline_success',NULL,'pipeline',NULL,NULL,NULL,NULL,'app','workbench',NULL,NULL,NULL),(7,'2021-05-28 03:54:58',NULL,'pipeline_failed',NULL,'pipeline',NULL,NULL,NULL,NULL,'app','workbench',NULL,NULL,NULL),(8,'2021-05-28 03:54:58',NULL,'issue_create',NULL,'issue',NULL,NULL,NULL,NULL,'project','workbench',NULL,NULL,NULL),(9,'2021-05-28 03:54:58',NULL,'issue_update',NULL,'issue',NULL,NULL,NULL,NULL,'project','workbench',NULL,NULL,NULL),(10,'2021-05-28 03:54:58',NULL,'git_create_mr',NULL,'git',NULL,NULL,NULL,NULL,'app','workbench',NULL,NULL,NULL),(11,NULL,NULL,'git_merge_mr',NULL,'git',NULL,NULL,NULL,NULL,'app','workbench',NULL,NULL,NULL),(12,NULL,NULL,'git_close_mr',NULL,'git',NULL,NULL,NULL,NULL,'app','workbench',NULL,NULL,NULL),(13,NULL,NULL,'git_comment_mr',NULL,'git',NULL,NULL,NULL,NULL,'app','workbench',NULL,NULL,NULL),(14,NULL,NULL,'git_delete_branch',NULL,'git',NULL,NULL,NULL,NULL,'app','workbanch',NULL,NULL,NULL),(15,NULL,NULL,'git_delete_tag',NULL,'git',NULL,NULL,NULL,NULL,'app','workbanch',NULL,NULL,NULL);

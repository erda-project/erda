CREATE TABLE `erda_aksk` (
  ...
  `subject_type` varchar(255) NOT NULL COMMENT 'authentication subject type. eg: organization, micro_service',
  `subject_id` varchar(255) NOT NULL COMMENT 'authentication subject id. eg: <orgID>',

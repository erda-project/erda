...
(
    ...
    `prod_cpu_quota`       DECIMAL(65, 2) NOT NULL DEFAULT 0.0 COMMENT '生产环境 CPU 配额',
    `prod_mem_quota`       DECIMAL(65, 2) NOT NULL DEFAULT 0.0 COMMENT '生产环境 Mem 配额',
    `staging_cpu_quota`    DECIMAL(65, 2) NOT NULL DEFAULT 0.0 COMMENT '预发环境 CPU 配额',
    `staging_mem_quota`    DECIMAL(65, 2) NOT NULL DEFAULT 0.0 COMMENT '预发环境 Mem 配额',
    `test_cpu_quota`       DECIMAL(65, 2) NOT NULL DEFAULT 0.0 COMMENT '测试环境 CPU 配额',
    `test_mem_quota`       DECIMAL(65, 2) NOT NULL DEFAULT 0.0 COMMENT '测试环境 Mem 配额',
    `dev_cpu_quota`        DECIMAL(65, 2) NOT NULL DEFAULT 0.0 COMMENT '开发环境 CPU 配额',
    `dev_mem_quota`        DECIMAL(65, 2) NOT NULL DEFAULT 0.0 COMMENT '发开环境 Mem 配额',

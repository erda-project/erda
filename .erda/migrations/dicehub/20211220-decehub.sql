...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='应用发布关联表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='action,addon扩展信息';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='action,addon扩展版本信息';
...
(
  ...
  AUTO_INCREMENT = 14
  DEFAULT CHARSET = utf8mb4 COMMENT ='流水线模板版本表';
...
(
  ...
  AUTO_INCREMENT = 14
  DEFAULT CHARSET = utf8mb4 COMMENT ='流水线模板表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='h5包适配的移动应用版本信息';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='发布版本';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='发布内容';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='发布内容黑名单';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='发布内容数据擦除列表';
...
(
    ...
    `is_project_release`       tinyint(1)   NOT NULL DEFAULT 0,
    `application_release_list` text,
  ...
  ROW_FORMAT DYNAMIC COMMENT ='Dice 版本表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  ROW_FORMAT DYNAMIC COMMENT ='Dice 镜像表';

...
// AIProxyModel is the table ai_proxy_model
type AIProxyModel struct {
	BaseModel
	...
	Type       string   `gorm:"column:type;type:varchar(32)" json:"type" yaml:"type"`
...
// TableName returns the table name ai_proxy_model
func (AIProxyModel) TableName() string { return "ai_proxy_model" }

type AIProxyModelList []*AIProxyModel

// TableName returns the table name ai_proxy_model
func (AIProxyModelList) TableName() string { return "ai_proxy_model" }

...
type AIProxyProviders struct {
	...
	InstanceID  string           `gorm:"column:instance_id;type:char(512)" json:"instanceID" yaml:"instanceID"`
	...
	DocSite     string           `gorm:"column:doc_site;type:varchar(1024)" json:"docSite" yaml:"docSite"`

...
func (p *provider) Init(ctx servicehub.Context) error {
	...
	mcppb.RegisterMCPServerServiceImp(p, handler_mcp_server.NewMCPHandler(p.Dao, p.Config.McpProxyAddr), apis.Options(), trySetAuth(p.Dao), permission.CheckMCPPerm)

...
import (
	...
	mcppb "github.com/erda-project/erda-proto-go/apps/aiproxy/mcp-server/pb"
	...
	"github.com/erda-project/erda/internal/apps/ai-proxy/handlers/handler_mcp"
...
func (p *provider) Init(ctx servicehub.Context) error {
	...
	mcppb.RegisterMCPServerServiceImp(p, &handler_mcp.MCPHandler{DAO: p.Dao}, apis.Options(), permission.CheckMCPPerm)

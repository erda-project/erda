...
func (p *provider) UserMe(ctx context.Context, r *pb.UserMeRequest) (*pb.UserMeResponse, error) {
...
func (p *provider) Me(ctx context.Context, r *pb.UserMeRequest) (*pb.UserMeResponse, error) {

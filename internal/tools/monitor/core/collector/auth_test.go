...
////go:generate mockgen -destination=./collector_validator_test.go -package collector github.com/erda-project/erda/modules/tools/monitor/oap/collector/authentication Validator

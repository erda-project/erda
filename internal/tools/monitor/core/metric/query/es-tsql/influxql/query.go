...
func (q *Query) SetAllColumnsCallback(fn func(start, end int64, sources []*model.Source) ([]*model.Column, error)) {
	q.allColumnsFn = fn
}
...
// ParseResult .
func (q *Query) ParseResult(resp *elastic.SearchResult) (*model.Data, error) {
	if resp != nil {

...
type Query interface {
	...
	SetAllColumnsCallback(fn func(start, end int64, sources []*model.Source) ([]*model.Column, error))
	ParseResult(resp *elastic.SearchResult) (*model.Data, error)
	Context() Context
	Debug() bool
...
type Parser interface {
	...
	ParseRawQuery() ([]*model.Source, *elastic.BoolQuery, *elastic.SearchSource, error)
}

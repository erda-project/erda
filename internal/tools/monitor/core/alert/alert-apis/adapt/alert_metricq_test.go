...
// Source: github.com/erda-project/erda/internal/tools/monitor/core/metric/query/metricq (interfaces: Queryer)
...
func (m *MockQueryer) Query(arg0, arg1 string, arg2 map[string]interface{}, arg3 url.Values) (*model.ResultSet, error) {
	m.ctrl.T.Helper()
...
func (m *MockQueryer) QueryWithFormat(arg0, arg1, arg2 string, arg3 i18n.LanguageCodes, arg4 map[string]interface{}, arg5 []*model.Filter, arg6 url.Values) (*model.ResultSet, interface{}, error) {
	m.ctrl.T.Helper()

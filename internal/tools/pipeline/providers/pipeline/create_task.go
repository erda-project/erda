...
func (s *pipelineService) makeNormalPipelineTask(p *spec.Pipeline, ps *spec.PipelineStage, action *pipelineyml.Action, passedDataWhenCreate *action_info.PassedDataWhenCreate) *spec.PipelineTask {
...
func (s *pipelineService) makeSnippetPipelineTask(p *spec.Pipeline, stage *spec.PipelineStage, action *pipelineyml.Action) *spec.PipelineTask {
...
func (s *pipelineService) genSnippetTaskExtra(p *spec.Pipeline, action *pipelineyml.Action) spec.PipelineTaskExtra {
...
func (s *pipelineService) calculateTaskTimeoutDuration(action *pipelineyml.Action) time.Duration {
...
func (s *pipelineService) calculateTaskRunAfter(action *pipelineyml.Action) []string {
...
func (s *pipelineService) judgeTaskExecutor(task *spec.PipelineTask, actionSpec *apistructs.ActionSpec) (spec.PipelineTaskExecutorKind, spec.PipelineTaskExecutorName) {
	if actionSpec == nil ||

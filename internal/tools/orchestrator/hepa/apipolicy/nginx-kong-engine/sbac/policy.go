...
func init() {
	if err := apipolicy.RegisterPolicyEngine(apipolicy.ProviderNKE, apipolicy.Policy_Engine_SBAC, &Policy{BasePolicy: &apipolicy.BasePolicy{}}); err != nil {
		panic(err)
	}
}

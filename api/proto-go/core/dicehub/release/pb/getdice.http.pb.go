...
func RegisterReleaseGetDiceServiceHandler(r http.Router, srv ReleaseGetDiceServiceHandler, opts ...http.HandleOption) {
	...
	add_PullDiceYAML := func(method, path string, fn func(context.Context, *ReleaseGetDiceYmlRequest) (*ReleaseGetDiceYmlResponse, error)) {
		...
		var PullDiceYAML_info transport.ServiceInfo
		if h.Interceptor != nil {
			PullDiceYAML_info = transport.NewServiceInfo("erda.core.dicehub.release.ReleaseGetDiceService", "PullDiceYAML", srv)
	...
	add_GetDiceYAML := func(method, path string, fn func(context.Context, *ReleaseGetDiceYmlRequest) (*ReleaseGetDiceYmlResponse, error)) {
		handler := func(ctx context.Context, req interface{}) (interface{}, error) {
			return fn(ctx, req.(*ReleaseGetDiceYmlRequest))
		}
		var GetDiceYAML_info transport.ServiceInfo
		if h.Interceptor != nil {
			GetDiceYAML_info = transport.NewServiceInfo("erda.core.dicehub.release.ReleaseGetDiceService", "GetDiceYAML", srv)
			handler = h.Interceptor(handler)
		}
		compiler, _ := httprule.Parse(path)
		temp := compiler.Compile()
	...
	add_PullDiceYAML("GET", "/api/releases/{releaseID}/actions/pull", srv.PullDiceYAML)
	add_GetDiceYAML("GET", "/api/releases/{releaseID}/actions/get-dice", srv.GetDiceYAML)
}

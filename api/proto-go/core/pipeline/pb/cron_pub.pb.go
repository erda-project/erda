...
var file_cron_pub_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x95, 0x06, 0x0a, 0x04, 0x43, 0x72, 0x6f, 0x6e, 0x12, 0x0e,
	...
	0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x42, 0x38, 0x5a,
...
var file_cron_pub_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_cron_pub_proto_goTypes = []interface{}{
	(*Cron)(nil),                  // 0: erda.core.pipeline.Cron
	nil,                           // 1: erda.core.pipeline.Cron.SecretsEntry
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
	(*wrapperspb.BoolValue)(nil),  // 3: google.protobuf.BoolValue
}
var file_cron_pub_proto_depIdxs = []int32{
	2, // 0: erda.core.pipeline.Cron.timeCreated:type_name -> google.protobuf.Timestamp
	2, // 1: erda.core.pipeline.Cron.timeUpdated:type_name -> google.protobuf.Timestamp
	2, // 2: erda.core.pipeline.Cron.cronStartTime:type_name -> google.protobuf.Timestamp
	3, // 3: erda.core.pipeline.Cron.enable:type_name -> google.protobuf.BoolValue
	1, // 4: erda.core.pipeline.Cron.secrets:type_name -> erda.core.pipeline.Cron.SecretsEntry

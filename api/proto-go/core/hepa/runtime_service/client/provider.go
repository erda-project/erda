...
var dependencies = []string{
	"grpc-client@erda.core.hepa.runtime_service",
	"grpc-client",
}
...
func (p *provider) Provide(ctx servicehub.DependencyContext, args ...interface{}) interface{} {
	...
	switch ctx.Service() {
	case "erda.core.hepa.runtime_service-client":
		return p.client
	case "erda.core.hepa.runtime_service.RuntimeService":
		return &runtimeServiceWrapper{client: p.client.RuntimeService(), opts: opts}
	case "erda.core.hepa.runtime_service.RuntimeService.client":
...
func init() {
	servicehub.Register("erda.core.hepa.runtime_service-client", &servicehub.Spec{
		Services: []string{
			"erda.core.hepa.runtime_service.RuntimeService",
			"erda.core.hepa.runtime_service.RuntimeService.client",
			"erda.core.hepa.runtime_service-client",
		},
		Types: []reflect.Type{
			clientsType,
			// client types

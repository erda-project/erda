...
func RegisterDiagnotorServiceHandler(r http.Router, srv DiagnotorServiceHandler, opts ...http.HandleOption) {
	...
	add_StartDiagnosis := func(method, path string, fn func(context.Context, *StartDiagnosisRequest) (*StartDiagnosisResponse, error)) {
		...
		if h.Interceptor != nil {
			StartDiagnosis_info = transport.NewServiceInfo("erda.core.monitor.diagnotor.DiagnotorService", "StartDiagnosis", srv)
	...
	add_QueryDiagnosisStatus := func(method, path string, fn func(context.Context, *QueryDiagnosisStatusRequest) (*QueryDiagnosisStatusResponse, error)) {
		...
		if h.Interceptor != nil {
			QueryDiagnosisStatus_info = transport.NewServiceInfo("erda.core.monitor.diagnotor.DiagnotorService", "QueryDiagnosisStatus", srv)
			handler = h.Interceptor(handler)
		}
	...
	add_StopDiagnosis := func(method, path string, fn func(context.Context, *StopDiagnosisRequest) (*StopDiagnosisResponse, error)) {
		...
		if h.Interceptor != nil {
			StopDiagnosis_info = transport.NewServiceInfo("erda.core.monitor.diagnotor.DiagnotorService", "StopDiagnosis", srv)
			handler = h.Interceptor(handler)
		}
		compiler, _ := httprule.Parse(path)
		temp := compiler.Compile()
	...
	add_ListProcesses := func(method, path string, fn func(context.Context, *ListProcessesRequest) (*ListProcessesResponse, error)) {
		...
		if h.Interceptor != nil {
			ListProcesses_info = transport.NewServiceInfo("erda.core.monitor.diagnotor.DiagnotorService", "ListProcesses", srv)
			handler = h.Interceptor(handler)
		}
		compiler, _ := httprule.Parse(path)
		temp := compiler.Compile()
	...
	add_StartDiagnosis("POST", "/api/diagnosis", srv.StartDiagnosis)
	add_QueryDiagnosisStatus("GET", "/api/diagnosis/namespaces/{namespace}/pods/{podName}/status", srv.QueryDiagnosisStatus)
	add_StopDiagnosis("DELETE", "/api/diagnosis/namespaces/{namespace}/pods/{podName}", srv.StopDiagnosis)
	add_ListProcesses("GET", "/api/diagnosis/namespaces/{namespace}/pods/{podName}/processes", srv.ListProcesses)
}

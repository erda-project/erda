...
type Client interface {
	// NotifyGroupService notify_group.proto
...
func (s *notifyGroupServiceWrapper) BatchGetNotifyGroup(ctx context.Context, req *pb.BatchGetNotifyGroupRequest) (*pb.BatchGetNotifyGroupResponse, error) {
	return s.client.BatchGetNotifyGroup(ctx, req, append(grpc.CallOptionFromContext(ctx), s.opts...)...)
}

...
var _ urlenc.URLValuesUnmarshaler = (*UpdateProjectPipelineSourceRequest)(nil)
var _ urlenc.URLValuesUnmarshaler = (*UpdateProjectPipelineSourceResponse)(nil)
...
// UpdateProjectPipelineSourceRequest implement urlenc.URLValuesUnmarshaler.
func (m *UpdateProjectPipelineSourceRequest) UnmarshalURLValues(prefix string, values url.Values) error {
	for key, vals := range values {
		if len(vals) > 0 {
			switch prefix + key {
			case "pipelineDefinitionID":
...
// UpdateProjectPipelineSourceResponse implement urlenc.URLValuesUnmarshaler.
func (m *UpdateProjectPipelineSourceResponse) UnmarshalURLValues(prefix string, values url.Values) error {
	for key, vals := range values {
		if len(vals) > 0 {
			switch prefix + key {
			case "ProjectPipeline":

...
type Span struct {
	...
	StratTimeUnixNano uint64 `protobuf:"fixed64,4,opt,name=stratTimeUnixNano,proto3" json:"stratTimeUnixNano,omitempty"`
...
func (x *Span) GetStratTimeUnixNano() uint64 {
	if x != nil {
		return x.StratTimeUnixNano
	}
	return 0
}
...
var file_tracing_proto_rawDesc = []byte{
	...
	0x70, 0x61, 0x6e, 0x49, 0x44, 0x12, 0x2c, 0x0a, 0x11, 0x73, 0x74, 0x72, 0x61, 0x74, 0x54, 0x69,
	0x6d, 0x65, 0x55, 0x6e, 0x69, 0x78, 0x4e, 0x61, 0x6e, 0x6f, 0x18, 0x04, 0x20, 0x01, 0x28, 0x06,
	0x52, 0x11, 0x73, 0x74, 0x72, 0x61, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x55, 0x6e, 0x69, 0x78, 0x4e,

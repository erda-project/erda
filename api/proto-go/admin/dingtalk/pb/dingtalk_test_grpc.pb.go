...
func (c *dingTalkTestServiceClient) SendTestMessage(ctx context.Context, in *DingTalkTestRequest, opts ...grpc.CallOption) (*DingTalkTestResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/erda.admin.dingtalk.DingTalkTestService/SendTestMessage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var _DingTalkTestService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "erda.admin.dingtalk.DingTalkTestService",
...
func _get_DingTalkTestService_serviceDesc(srv DingTalkTestServiceServer, opts ...grpc1.HandleOption) *grpc.ServiceDesc {
	...
	if h.Interceptor != nil {
		_DingTalkTestService_SendTestMessage_info = transport.NewServiceInfo("erda.admin.dingtalk.DingTalkTestService", "SendTestMessage", srv)
	...
	serviceDesc.Methods = []grpc.MethodDesc{
		{
			...
			Handler: func(_ interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
				...
				info := &grpc.UnaryServerInfo{
					Server:     srv,
					FullMethod: "/erda.admin.dingtalk.DingTalkTestService/SendTestMessage",
				}

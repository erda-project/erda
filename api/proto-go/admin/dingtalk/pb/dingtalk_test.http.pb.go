...
func RegisterDingTalkTestServiceHandler(r http.Router, srv DingTalkTestServiceHandler, opts ...http.HandleOption) {
	...
	add_SendTestMessage := func(method, path string, fn func(context.Context, *DingTalkTestRequest) (*DingTalkTestResponse, error)) {
		handler := func(ctx context.Context, req interface{}) (interface{}, error) {
			return fn(ctx, req.(*DingTalkTestRequest))
		}
		var SendTestMessage_info transport.ServiceInfo
		if h.Interceptor != nil {
			SendTestMessage_info = transport.NewServiceInfo("erda.admin.dingtalk.DingTalkTestService", "SendTestMessage", srv)
	...
	add_SendTestMessage("POST", "/api/admin/notify/dingtalk-test", srv.SendTestMessage)
}

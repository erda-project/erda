...
type GetTenantProjectRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetTenantProjectRequest) Reset() {
	*x = GetTenantProjectRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetTenantProjectRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetTenantProjectRequest) ProtoMessage() {}

func (x *GetTenantProjectRequest) ProtoReflect() protoreflect.Message {
	mi := &file_tenant_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetTenantProjectRequest.ProtoReflect.Descriptor instead.
func (*GetTenantProjectRequest) Descriptor() ([]byte, []int) {
	return file_tenant_proto_rawDescGZIP(), []int{7}
}

func (x *GetTenantProjectRequest) GetScopeId() string {
	if x != nil {
		return x.ScopeId
	}
	return ""
...
type GetTenantProjectResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Data *TenantProjectData `protobuf:"bytes,1,opt,name=data,proto3" json:"data,omitempty"`
}

func (x *GetTenantProjectResponse) Reset() {
	*x = GetTenantProjectResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetTenantProjectResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetTenantProjectResponse) ProtoMessage() {}

func (x *GetTenantProjectResponse) ProtoReflect() protoreflect.Message {
	mi := &file_tenant_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetTenantProjectResponse.ProtoReflect.Descriptor instead.
func (*GetTenantProjectResponse) Descriptor() ([]byte, []int) {
	return file_tenant_proto_rawDescGZIP(), []int{8}
}

func (x *GetTenantProjectResponse) GetData() *TenantProjectData {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *TenantProjectData) Reset() {
	*x = TenantProjectData{}
	if protoimpl.UnsafeEnabled {
...
func (x *TenantProjectData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TenantProjectData) ProtoMessage() {}

func (x *TenantProjectData) ProtoReflect() protoreflect.Message {
	mi := &file_tenant_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TenantProjectData.ProtoReflect.Descriptor instead.
func (*TenantProjectData) Descriptor() ([]byte, []int) {
	return file_tenant_proto_rawDescGZIP(), []int{9}
}

func (x *TenantProjectData) GetWorkspace() string {
	if x != nil {
		return x.Workspace
	}
	return ""
...
func (x *TenantProjectData) GetProjectId() string {
	if x != nil {
		return x.ProjectId
	}
	return ""
...
var file_tenant_proto_rawDesc = []byte{
	...
	0x33, 0x0a, 0x17, 0x47, 0x65, 0x74, 0x54, 0x65, 0x6e, 0x61, 0x6e, 0x74, 0x50, 0x72, 0x6f, 0x6a,
	...
	0x70, 0x65, 0x49, 0x64, 0x22, 0x52, 0x0a, 0x18, 0x47, 0x65, 0x74, 0x54, 0x65, 0x6e, 0x61, 0x6e,
	...
	,
	...
	,
	...
	,
	...
	0x63, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x42, 0x35, 0x5a, 0x33, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
	...
	0x6d, 0x73, 0x70, 0x2f, 0x74, 0x65, 0x6e, 0x61, 0x6e, 0x74, 0x2f, 0x70, 0x62, 0x62, 0x06, 0x70,
...
var file_tenant_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_tenant_proto_goTypes = []interface{}{
	...
	(*GetTenantProjectRequest)(nil),  // 9: erda.msp.tenant.GetTenantProjectRequest
	(*GetTenantProjectResponse)(nil), // 10: erda.msp.tenant.GetTenantProjectResponse
	(*TenantProjectData)(nil),        // 11: erda.msp.tenant.TenantProjectData
}
var file_tenant_proto_depIdxs = []int32{
	...
	11, // 3: erda.msp.tenant.GetTenantProjectResponse.data:type_name -> erda.msp.tenant.TenantProjectData
	2,  // 4: erda.msp.tenant.TenantService.CreateTenant:input_type -> erda.msp.tenant.CreateTenantRequest
	4,  // 5: erda.msp.tenant.TenantService.GetTenant:input_type -> erda.msp.tenant.GetTenantRequest
	6,  // 6: erda.msp.tenant.TenantService.DeleteTenant:input_type -> erda.msp.tenant.DeleteTenantRequest
	9,  // 7: erda.msp.tenant.TenantService.GetTenantProject:input_type -> erda.msp.tenant.GetTenantProjectRequest
	3,  // 8: erda.msp.tenant.TenantService.CreateTenant:output_type -> erda.msp.tenant.CreateTenantResponse
	5,  // 9: erda.msp.tenant.TenantService.GetTenant:output_type -> erda.msp.tenant.GetTenantResponse
	7,  // 10: erda.msp.tenant.TenantService.DeleteTenant:output_type -> erda.msp.tenant.DeleteTenantResponse
	10, // 11: erda.msp.tenant.TenantService.GetTenantProject:output_type -> erda.msp.tenant.GetTenantProjectResponse
...
func file_tenant_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_tenant_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetTenantProjectRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_tenant_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetTenantProjectResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_tenant_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TenantProjectData); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache

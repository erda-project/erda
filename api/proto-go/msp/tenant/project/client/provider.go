...
var dependencies = []string{
	"grpc-client@erda.msp.tenant.project",
	"grpc-client",
}
...
var (
	...
	projectServiceClientType = reflect.TypeOf((*pb.ProjectServiceClient)(nil)).Elem()
	projectServiceServerType = reflect.TypeOf((*pb.ProjectServiceServer)(nil)).Elem()
)
...
func (p *provider) Provide(ctx servicehub.DependencyContext, args ...interface{}) interface{} {
	...
	switch ctx.Service() {
	case "erda.msp.tenant.project-client":
		return p.client
	case "erda.msp.tenant.project.ProjectService":
		return &projectServiceWrapper{client: p.client.ProjectService(), opts: opts}
	case "erda.msp.tenant.project.ProjectService.client":
		return p.client.ProjectService()
	}
	switch ctx.Type() {
	case clientsType:
		return p.client
	case projectServiceClientType:
		return p.client.ProjectService()
	case projectServiceServerType:
		return &projectServiceWrapper{client: p.client.ProjectService(), opts: opts}
	}
	return p
}

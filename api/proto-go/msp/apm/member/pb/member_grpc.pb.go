...
func (c *memberServiceClient) ScopeRoleAccess(ctx context.Context, in *ScopeRoleAccessRequest, opts ...grpc.CallOption) (*ScopeRoleAccessResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/erda.msp.apm.member.MemberService/ScopeRoleAccess", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *memberServiceClient) ListMember(ctx context.Context, in *ListMemberRequest, opts ...grpc.CallOption) (*ListMemberResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/erda.msp.apm.member.MemberService/ListMember", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *memberServiceClient) CreateOrUpdateMember(ctx context.Context, in *CreateOrUpdateMemberRequest, opts ...grpc.CallOption) (*CreateOrUpdateMemberResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/erda.msp.apm.member.MemberService/CreateOrUpdateMember", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *memberServiceClient) DeleteMember(ctx context.Context, in *DeleteMemberRequest, opts ...grpc.CallOption) (*DeleteMemberResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/erda.msp.apm.member.MemberService/DeleteMember", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *memberServiceClient) ListMemberRoles(ctx context.Context, in *ListMemberRolesRequest, opts ...grpc.CallOption) (*ListMemberRolesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/erda.msp.apm.member.MemberService/ListMemberRoles", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var _MemberService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "erda.msp.apm.member.MemberService",
...
func _get_MemberService_serviceDesc(srv MemberServiceServer, opts ...grpc1.HandleOption) *grpc.ServiceDesc {
	...
	if h.Interceptor != nil {
		_MemberService_ScopeRoleAccess_info = transport.NewServiceInfo("erda.msp.apm.member.MemberService", "ScopeRoleAccess", srv)
	...
	if h.Interceptor != nil {
		_MemberService_ListMember_info = transport.NewServiceInfo("erda.msp.apm.member.MemberService", "ListMember", srv)
	...
	if h.Interceptor != nil {
		_MemberService_CreateOrUpdateMember_info = transport.NewServiceInfo("erda.msp.apm.member.MemberService", "CreateOrUpdateMember", srv)
	...
	if h.Interceptor != nil {
		_MemberService_DeleteMember_info = transport.NewServiceInfo("erda.msp.apm.member.MemberService", "DeleteMember", srv)
	...
	if h.Interceptor != nil {
		_MemberService_ListMemberRoles_info = transport.NewServiceInfo("erda.msp.apm.member.MemberService", "ListMemberRoles", srv)
	...
	serviceDesc.Methods = []grpc.MethodDesc{
		{
			...
			Handler: func(_ interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
				...
				info := &grpc.UnaryServerInfo{
					Server:     srv,
					FullMethod: "/erda.msp.apm.member.MemberService/ScopeRoleAccess",
				}
		...
		},
		{
			...
			Handler: func(_ interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
				...
				info := &grpc.UnaryServerInfo{
					Server:     srv,
					FullMethod: "/erda.msp.apm.member.MemberService/ListMember",
				}
		...
		},
		{
			...
			Handler: func(_ interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
				...
				info := &grpc.UnaryServerInfo{
					Server:     srv,
					FullMethod: "/erda.msp.apm.member.MemberService/CreateOrUpdateMember",
				}
		...
		},
		{
			...
			Handler: func(_ interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
				...
				info := &grpc.UnaryServerInfo{
					Server:     srv,
					FullMethod: "/erda.msp.apm.member.MemberService/DeleteMember",
				}
		...
		},
		{
			...
			Handler: func(_ interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
				...
				info := &grpc.UnaryServerInfo{
					Server:     srv,
					FullMethod: "/erda.msp.apm.member.MemberService/ListMemberRoles",
				}

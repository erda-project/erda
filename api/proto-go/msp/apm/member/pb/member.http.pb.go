...
func RegisterMemberServiceHandler(r http.Router, srv MemberServiceHandler, opts ...http.HandleOption) {
	...
	add_ScopeRoleAccess := func(method, path string, fn func(context.Context, *ScopeRoleAccessRequest) (*ScopeRoleAccessResponse, error)) {
		...
		if h.Interceptor != nil {
			ScopeRoleAccess_info = transport.NewServiceInfo("erda.msp.apm.member.MemberService", "ScopeRoleAccess", srv)
	...
	add_ListMember := func(method, path string, fn func(context.Context, *ListMemberRequest) (*ListMemberResponse, error)) {
		...
		if h.Interceptor != nil {
			ListMember_info = transport.NewServiceInfo("erda.msp.apm.member.MemberService", "ListMember", srv)
			handler = h.Interceptor(handler)
		}
		r.Add(method, path, encodeFunc(
			func(w http1.ResponseWriter, r *http1.Request) (interface{}, error) {
	...
	add_CreateOrUpdateMember := func(method, path string, fn func(context.Context, *CreateOrUpdateMemberRequest) (*CreateOrUpdateMemberResponse, error)) {
		...
		if h.Interceptor != nil {
			CreateOrUpdateMember_info = transport.NewServiceInfo("erda.msp.apm.member.MemberService", "CreateOrUpdateMember", srv)
			handler = h.Interceptor(handler)
		}
		r.Add(method, path, encodeFunc(
			func(w http1.ResponseWriter, r *http1.Request) (interface{}, error) {
	...
	add_DeleteMember := func(method, path string, fn func(context.Context, *DeleteMemberRequest) (*DeleteMemberResponse, error)) {
		...
		if h.Interceptor != nil {
			DeleteMember_info = transport.NewServiceInfo("erda.msp.apm.member.MemberService", "DeleteMember", srv)
			handler = h.Interceptor(handler)
		}
		r.Add(method, path, encodeFunc(
			func(w http1.ResponseWriter, r *http1.Request) (interface{}, error) {
	...
	add_ListMemberRoles := func(method, path string, fn func(context.Context, *ListMemberRolesRequest) (*ListMemberRolesResponse, error)) {
		...
		if h.Interceptor != nil {
			ListMemberRoles_info = transport.NewServiceInfo("erda.msp.apm.member.MemberService", "ListMemberRoles", srv)
			handler = h.Interceptor(handler)
		}
		r.Add(method, path, encodeFunc(
			func(w http1.ResponseWriter, r *http1.Request) (interface{}, error) {
	...
	add_ScopeRoleAccess("POST", "/api/msp/apm/permission/access", srv.ScopeRoleAccess)
	add_ListMember("GET", "/api/apm/msp/members", srv.ListMember)
	add_CreateOrUpdateMember("POST", "/api/msp/apm/members", srv.CreateOrUpdateMember)
	add_DeleteMember("POST", "/api/msp/apm/members/action/remove", srv.DeleteMember)
	add_ListMemberRoles("GET", "/api/msp/apm/members/action/list-roles", srv.ListMemberRoles)
}

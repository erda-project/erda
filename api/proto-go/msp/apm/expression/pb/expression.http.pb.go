...
func RegisterExpressionServiceHandler(r http.Router, srv ExpressionServiceHandler, opts ...http.HandleOption) {
	...
	add_GetExpression := func(method, path string, fn func(context.Context, *GetExpressionRequest) (*GetExpressionResponse, error)) {
		handler := func(ctx context.Context, req interface{}) (interface{}, error) {
			return fn(ctx, req.(*GetExpressionRequest))
		}
		var GetExpression_info transport.ServiceInfo
		if h.Interceptor != nil {
			GetExpression_info = transport.NewServiceInfo("erda.msp.apm.expression.ExpressionService", "GetExpression", srv)
	...
	add_GetExpression("GET", "/api/msp/expression/{type}", srv.GetExpression)
}

...
import (
	...
	i18n2 "github.com/erda-project/erda/modules/admin/component-protocol/components/personal-workbench/i18n"
...
func TestWorkCards_getProjectCardOps(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			wc := &WorkCards{}
			wc.getProjectCardOps(tt.args.params, tt.args.project)
		})
	}
}

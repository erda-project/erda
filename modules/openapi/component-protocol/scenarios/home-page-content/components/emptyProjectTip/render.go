...
func (this *EmptyProjectTip) SetCtxBundle(ctx context.Context) error {
...
func (this *EmptyProjectTip) GenComponentState(c *apistructs.Component) error {
...
func (this *EmptyProjectTip) getProjectsNum(orgID string) (int, error) {

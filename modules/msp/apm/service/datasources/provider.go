...
type ServiceDataSource interface {
	...
	GetBubbleChart(ctx context.Context, bubbleType BubbleChartType, preferredChartPoints int, start, end int64, tenantId, serviceId string, layer common.TransactionLayerType, path string) (*bubblegraph.Data, error)

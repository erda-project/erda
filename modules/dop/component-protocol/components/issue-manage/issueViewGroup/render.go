...
func (ca *ComponentAction) Render(ctx context.Context, c *cptype.Component, scenario cptype.Scenario, event cptype.ComponentEvent, gs *cptype.GlobalStateData) error {
	...
	fmt.Println("!!!!!!!!!", cputil.I18n(ctx, "issue-manage"))
	...
	case apistructs.InitializeOperation, apistructs.RenderingOperation:
		if urlQueryI, ok := sdk.InParams[getStateUrlQueryKey()]; ok {
...
func setState(c *cptype.Component, state State) error {
...
func init() {
	base.InitProviderWithCreator("issue-manage", "issueViewGroup", func() servicehub.Provider {

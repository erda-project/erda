...
func init() {
	base.InitProviderWithCreator("issue-manage", "issueKanbanV2", func() servicehub.Provider {
		return &Kanban{}
	})
}

func (k *Kanban) Initialize(sdk *cptype.SDK) {}
func (k *Kanban) Finalize(sdk *cptype.SDK)   { sdk.SetUserIDs(k.StdDataPtr.UserIDs) }
func (k *Kanban) BeforeHandleOp(sdk *cptype.SDK) {
	...
	cputil.MustObjJSONTransfer(k.StdStatePtr.Get(stateKeyIssueFilterConditions), &k.filterReq)
	// issue type

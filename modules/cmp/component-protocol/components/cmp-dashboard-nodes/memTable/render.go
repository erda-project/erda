...
func (mt *MemInfoTable) GetProps() map[string]interface{} {
	return map[string]interface{}{
		...
		"columns": []table.Columns{
			{DataIndex: "Node", Title: mt.SDK.I18n("node"), Sortable: true, Width: 400, Show: true},
			{DataIndex: "Status", Title: mt.SDK.I18n("status"), Sortable: true, Show: true},
			{DataIndex: "Distribution", Title: mt.SDK.I18n("distribution"), Sortable: true, Align: "right", Show: true},
			{DataIndex: "Usage", Title: mt.SDK.I18n("usedRate"), Sortable: true, Align: "right", Show: true},
			{DataIndex: "DistributionRate", Title: mt.SDK.I18n("distributionRate"), Sortable: true, TitleTip: mt.SDK.I18n("The proportion of allocated resources that are used"), Show: false},
			{DataIndex: "IP", Title: mt.SDK.I18n("ip"), Sortable: true, Show: true},
			{DataIndex: "Role", Title: mt.SDK.I18n("Role"), Sortable: true, Show: true},
			{DataIndex: "Version", Title: mt.SDK.I18n("version"), Sortable: true, Show: false},
			{DataIndex: "Operate", Title: mt.SDK.I18n("operate"), Fixed: "right", Show: true},
		},
		"selectable":      true,

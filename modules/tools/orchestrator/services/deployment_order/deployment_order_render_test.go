...
func TestRenderDetail(t *testing.T) {
	...
	defer monkey.UnpatchAll()
	monkey.PatchInstanceMethod(reflect.TypeOf(releaseSvc), "GetRelease", func(*release.ReleaseService, context.Context, *pb.ReleaseGetRequest) (*pb.ReleaseGetResponse, error) {

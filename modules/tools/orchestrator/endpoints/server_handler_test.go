...
func TestEndpoints_batchRuntimeReDeploy(t *testing.T) {
	...
	runtimeScaleRecords := apistructs.RuntimeScaleRecords{
	...
	got = s.batchRuntimeReDeploy(ctx, userID, rts, runtimeScaleRecords)
...
func TestEndpoints_batchRuntimeDelete(t *testing.T) {
	...
	var rts []dbclient.Runtime
	got = s.batchRuntimeDelete(userID, rts, runtimeScaleRecords)

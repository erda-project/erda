...
func (o *Org) ensureNexusOrgMavenGroupRepos(org *model.Org) error {
...
func (o *Org) ensureNexusMavenHostedOrgSnapshotRepo(org *model.Org) (*apistructs.NexusRepository, error) {
...
func (o *Org) ensureNexusMavenGroupOrgRepo(org *model.Org, mavenMemberRepos []*apistructs.NexusRepository) (*apistructs.NexusRepository, error) {

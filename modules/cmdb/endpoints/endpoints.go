...
func (e *Endpoints) Routes() []httpserver.Endpoint {
	return []httpserver.Endpoint{
		...
		{Path: "/api/issues/{id}/subscribe", Method: http.MethodPost, Handler: e.SubscribeIssue},
		{Path: "/api/issues/{id}/unsubscribe", Method: http.MethodPost, Handler: e.UnsubscribeIssue},
		// issue state

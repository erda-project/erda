...
var (
	...
	ErrPipengine             = err("ErrPipengine", "流程引擎错误")
	...
	ErrListPipelineLabels    = err("ErrListPipelineLabels", "查询流水线标签列表失败")
	...
	ErrCreatePipelineArchive = err("ErrCreatePipelineArchive", "创建流水线归档失败")
	...
	ErrBatchQuerySnippetYaml = err("ErrBatchQuerySnippetYaml", "批量查询嵌套流水线片段失败")

	ErrFetchSecrets          = err("ErrFetchSecrets", "获取私有配置失败")

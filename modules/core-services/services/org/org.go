...
// GetOrgByDomainAndOrgName Get Org by domain and org name
...
func (o *Org) GenVerifyCode(identityInfo apistructs.IdentityInfo, orgID uint64) (string, error) {
	now := time.Now()

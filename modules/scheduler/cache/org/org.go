...
func init() {
	...
	orgID2Org = cache.New("scheduler-org-id-for-org", time.Minute, func(i interface{}) (interface{}, bool) {
	...
	projectID2Org = cache.New("scheduler-project-id-for-org", time.Minute, func(i interface{}) (interface{}, bool) {

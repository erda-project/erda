...
var interestedEventCommentFirstMap = map[string]string{
	...
	events.HostPortConflict:         errHostPortConflict,
	events.NodeSelectorMismatching:  errNodeSelectorMismatching,
	events.InsufficientFreeCPU:      errInsufficientFreeCPU,
	events.InsufficientFreeMemory:   errInsufficientFreeMemory,

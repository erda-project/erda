...
func (k *Kubernetes) ListUnitedDeployment(clusterName, namespace string) (*v1alpha1.UnitedDeploymentList, error) {
	...
	unitedDeployments, err := clientSet.CustomClient.OpenYurtV1alpha1().UnitedDeployments(namespace).List(context.TODO(), metav1.ListOptions{})
	if err != nil {
...
func (k *Kubernetes) GetUnitedDeployment(clusterName, namespace, unitedDeploymentName string) (*v1alpha1.UnitedDeployment, error) {
	...
	res, err := clientSet.CustomClient.OpenYurtV1alpha1().UnitedDeployments(namespace).Get(context.TODO(), unitedDeploymentName, metav1.GetOptions{})
	if err != nil {
...
func (k *Kubernetes) CreateUnitedDeployment(clusterName, namespace string, unitedDeployment *v1alpha1.UnitedDeployment) (*v1alpha1.UnitedDeployment, error) {
	...
	res, err := clientSet.CustomClient.OpenYurtV1alpha1().UnitedDeployments(namespace).Create(context.TODO(), unitedDeployment)
	if err != nil {
		return nil, fmt.Errorf("cluster %s create united deployment %s error, %v", clusterName, unitedDeployment.Name, err)
	}
...
func (k *Kubernetes) DeleteUnitedDeployment(clusterName, namespace string, unitedDeploymentName string) error {
	...
	err = clientSet.CustomClient.OpenYurtV1alpha1().UnitedDeployments(namespace).Delete(context.TODO(),
		unitedDeploymentName, &metav1.DeleteOptions{})
	if err != nil {
...
func (k *Kubernetes) UpdateUnitedDeployment(clusterName, namespace string, unitedDeployment *v1alpha1.UnitedDeployment) error {
	...
	_, err = clientSet.CustomClient.OpenYurtV1alpha1().UnitedDeployments(namespace).Update(context.TODO(), unitedDeployment)
	if err != nil {
...
// GenerateUnitedDeploymentSepc Generate Uniteddeployment spec

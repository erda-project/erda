...
import (
	...
	"github.com/erda-project/erda/modules/ops/impl/aliyun-resources/ack"
	"github.com/erda-project/erda/modules/ops/impl/aliyun-resources/ecs"
	"github.com/erda-project/erda/modules/ops/impl/aliyun-resources/eip"
	"github.com/erda-project/erda/modules/ops/impl/aliyun-resources/es"
	"github.com/erda-project/erda/modules/ops/impl/aliyun-resources/nas"
	"github.com/erda-project/erda/modules/ops/impl/aliyun-resources/rds"
...
func (e *Endpoints) TagResources(ctx context.Context, r *http.Request, vars map[string]string) (httpserver.Responser, error) {
	...
	if !req.IsNewCluster && (req.VpcID == "" || req.Region == "" ||
		...
		logrus.Infof("get ops config from db, cluster name: %v", req.ClusterName)

...
func (e *Edge) CreateEdgeMysql(req *apistructs.EdgeAppCreateRequest) error {
	...
	if _, err = e.k8s.CreateUnitedDeployment(clusterInfo.Name, namespace, masterUD); err != nil {
		return err
	}
	...
	if _, err = e.k8s.CreateUnitedDeployment(clusterInfo.Name, namespace, slaveUD); err != nil {
		return err
	}

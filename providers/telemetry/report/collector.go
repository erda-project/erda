...
func (client *ReportClient) CreateReportClient(addr, username, password string) *ReportClient {
	return &ReportClient{
		CFG: &config{
			ReportConfig: &ReportConfig{
				Collector: &c.CollectorConfig{
					Addr:     addr,
					UserName: username,
					Password: password,
				},
...
func newCollectorReporter(cfg *c.CollectorConfig) (*ReportClient, error) {
	return &ReportClient{
		HttpClient: &http.Client{

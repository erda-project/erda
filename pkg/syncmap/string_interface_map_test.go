...
func TestStringInterfaceMap_MarshalJSON(t *testing.T) {
	...
	m.Store("1", []*commonpb.MetadataFieldField{Name: "name1", Value: "value1"})
	m.Store("2", 2)
...
func TestStringInterfaceMap_UnmarshalJSON(t *testing.T) {
	...
	var o []*commonpb.MetadataFieldField
	err = m.Get("1", &o)
	assert.NoError(t, err)
...
func TestStringInterfaceMap_MarshalJSON2(t *testing.T) {
	...
	e.Volumes.Store("k1", []*commonpb.MetadataFieldField{Name: "n1"})
	e.Volumes.Store("k2", []*commonpb.MetadataFieldField{Name: "n2"})
...
func TestStringInterfaceMap_GetMap(t *testing.T) {
	...
	assert.Equal(t, tmpMap["1"], []*commonpb.MetadataFieldField{Name: "name1", Value: "value1"})

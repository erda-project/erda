...
func TestNewNecessaryFieldLinter(t *testing.T) {
	linter := sqllint.New(
		linters.NewIDExistsLinter, linters.NewIDTypeLinter, linters.NewIDIsPrimaryLinter,
		linters.NewCreatedAtExistsLinter, linters.NewCreatedAtTypeLinter, linters.NewCreatedAtDefaultValueLinter,
		linters.NewUpdatedAtExistsLinter, linters.NewUpdatedAtTypeLinter, linters.NewUpdatedAtDefaultValueLinter, linters.NewUpdatedAtOnUpdateLinter)

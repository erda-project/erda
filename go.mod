...
require (
	...
	github.com/erda-project/erda-infra v0.0.0-20211011082925-14815035670a
	github.com/erda-project/erda-infra/tools v0.0.0-20211011082925-14815035670a // indirect

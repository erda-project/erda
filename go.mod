...
require (
	...
	github.com/erda-project/erda-proto-go v0.0.0-20210909063402-581286d7b3de
...
replace (
	github.com/erda-project/erda-proto-go v0.0.0-20210908122055-e9a71c35f41b => ../erda-proto-go

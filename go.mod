...
require (
	...
	github.com/erda-project/erda-proto-go v0.0.0-20210705021945-e3b563362bc1
...
replace (
	...
	github.com/erda-project/erda-proto-go => github.com/recallsong/erda-proto-go v0.0.0-20210705060607-b2a7f803e7af

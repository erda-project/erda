...
require (
	...
	github.com/erda-project/erda-infra v0.0.0-20220223015542-f8c153b37cff
	github.com/erda-project/erda-infra/tools v0.0.0-20220302072443-14a364b0cd52 // indirect
